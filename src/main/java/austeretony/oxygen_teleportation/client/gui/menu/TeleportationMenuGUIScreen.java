...
public class TeleportationMenuGUIScreen extends AbstractGUIScreen {
    ...
    public void onGuiClosed() {
        ...
        TeleportationManagerClient.instance().getImagesLoader().removeUnusedCampPreviewImagesDelegated();
        TeleportationManagerClient.instance().getImagesLoader().removeUnusedLocationPreviewImagesDelegated();
    }
