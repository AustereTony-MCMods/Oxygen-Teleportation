...
import austeretony.oxygen_teleportation.client.gui.menu.camps.InvitedPlayerGUIButton;
...
public class InvitationsGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        GUIScroller scroller = new GUIScroller(MathHelper.clamp(TeleportationConfig.MAX_INVITED_PLAYERS_PER_CAMP.getIntValue(), 5, 100), 5);
