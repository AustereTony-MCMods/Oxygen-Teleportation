...
public class LocationCreationGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("teleportation.gui.menu.locationCreationCallback"), true, GUISettings.instance().getTitleScale()));   
