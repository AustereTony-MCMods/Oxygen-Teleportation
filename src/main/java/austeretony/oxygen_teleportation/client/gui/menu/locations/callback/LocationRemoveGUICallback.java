...
public class LocationRemoveGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("teleportation.gui.menu.removeLocationCallback"), true, GUISettings.instance().getTitleScale()));
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(I18n.format("teleportation.gui.menu.removeCallback.request", this.section.getCurrentPoint().getName()), true, GUISettings.instance().getTextScale());
    }
