...
public class TeleportationSettingsContainer implements ElementsContainer {
    ...
    public void addGUI(GUIElementsFramework framework) {
        ...
        this.alignmentTeleportationMenu.addElement(new OxygenDropDownListWrapperEntry<Integer>(- 1, ClientReference.localize("oxygen_core.alignment.left")));
        this.alignmentTeleportationMenu.addElement(new OxygenDropDownListWrapperEntry<Integer>(0, ClientReference.localize("oxygen_core.alignment.center")));
        this.alignmentTeleportationMenu.addElement(new OxygenDropDownListWrapperEntry<Integer>(1, ClientReference.localize("oxygen_core.alignment.right")));

        this.alignmentTeleportationMenu.<OxygenDropDownListWrapperEntry<Integer>>setElementClickListener((element)->{
            EnumTeleportationGUISetting.TELEPORTATION_MENU_ALIGNMENT.get().setValue(String.valueOf(element.getWrapped()));
            OxygenManagerClient.instance().getClientSettingManager().changed();
        });
