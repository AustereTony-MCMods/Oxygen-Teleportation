...
public class CampCreationCallbackGUIFiller extends BackgroundGUIFiller {

    public CampCreationCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {
        super(xPosition, yPosition, width, height, TeleportationMenuGUIScreen.CREATE_POINT_CALLBACK_BACKGROUND);
    }
