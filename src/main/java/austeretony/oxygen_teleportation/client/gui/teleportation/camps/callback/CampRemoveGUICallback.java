...
public class CampRemoveGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(ClientReference.localize("teleportation.gui.menu.removeCampCallback"), true, GUISettings.instance().getTitleScale()));
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(ClientReference.localize("teleportation.gui.menu.removeCallback.request", this.section.getCurrentPoint().getName()), false, GUISettings.instance().getTextScale());
    }
