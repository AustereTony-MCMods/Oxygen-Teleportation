...
public class LeaveCampCallbackGUIFiller extends BackgroundGUIFiller {

    public LeaveCampCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {
        super(xPosition, yPosition, width, height, TeleportationMenuGUIScreen.LEAVE_CAMP_CALLBACK_BACKGROUND);
    }
