...
public class CampRemoveGUICallback extends AbstractGUICallback {
    ...
    protected void init() {
        ...
        this.addElement(new GUITextLabel(1, 1).setDisplayText(I18n.format("teleportation.menu.removeCampCallback"), true));
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element) {
        if (element == this.cancelButton)
            ...
            CampsManagerClient.instance().removeCampPointSynced(this.section.currentPoint.getId());
