...
public class LeaveCampGUICallback extends AbstractGUICallback {
    ...
    public LeaveCampGUICallback(MenuGUIScreen screen, CampsGUISection section, int width, int height) {
    ...
    protected void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("teleportation.menu.leaveCampCallback"), true));
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(I18n.format("teleportation.menu.leaveCallback.request", this.section.currentPoint.getName()), true, 0.8F);
    }
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element) {
        if (element == this.cancelButton)
            ...
            TeleportationManagerClient.instance().getCampsManager().leaveCampPointSynced(this.section.currentPoint.getId());
