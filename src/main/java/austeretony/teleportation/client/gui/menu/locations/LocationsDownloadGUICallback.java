...
public class LocationsDownloadGUICallback extends AbstractGUICallback {
    ...
    public LocationsDownloadGUICallback(MenuGUIScreen screen, LocationsGUISection section, int width, int height) {
    ...
    protected void init() {
        ...
        this.addElement(new GUITextLabel(1, 1).setDisplayText(I18n.format("teleportation.menu.locationsDownloadCallback"), true));
        this.addElement(new GUITextLabel(1, 12).setDisplayText(I18n.format("teleportation.menu.campsDownloadCallback.request"), true, 0.8F));        
